...
<p align="center"><strong>LegendRobot is an extraordinary telegram group manager bot developed with the help of bots available in Telegram.</strong></p>
...
This file should be placed in your `LegendRobot` folder, alongside the `__main__.py` file. 
